				 100,100,500,222,222,710,711,222,100,100,100,211,211,211,450,214,214,100,222,222,222,222,222,222,
				 100,100,500,500,222,710,710,100,100,100,100,211,211,211,710,211,211,100,100,100,100,100,100,100,
				 100,100,100,100,222,222,222,100,100,100,100,400,710,401,710,211,211,100,100,100,100,100,100,100,
...
function checkKey(e, value, checkArrows) {
	...
	// YEAH!! it remembers last keysPressed so can go from 1 diagonal to another!!
		...
		if (keysPressed[40]) {  /////////////////////////////// YES, WORKS 
			...
			if(paused){
				...
				reDraw=true;/// this necessary to distinguish from normal pause iterations, 
		/////   this is instead forcing a draw, so makes sure pause doesn't draw (and push item) again
	...
	///////////////////////////////////////////////////////
		...
		if (keysPressed[39]) {  
			...
			console.log("SUPER here"+superLastKey);
...
var then = startTime;/// I don't know, it seems to make it faster than having satrtTime down there
...
function loop() {
		...
		if(isPlaying){
			...
			/// Actually_Do_Stuff at a constant rate, no matter what hardware
...
//???????\\\\?//GAME HAPPENS HERE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
			...
			/// Enable loop (and maybe do stuff)
			requestAnimFrame(loop);
...
/////  DONT FLASH, OR RESET ANIMCOUNTER >>> IF ITS NOT YOUR MENUTRACK (flashing gun-item when scrolling item-item)
...
for (var i =0; i<3; i++) { ///// 3 Tracks
			...
			if(i==0){
				if(player1.items[1]!=null&&player1.items[1]!="undefined"){
						...
						////  COULD ANIMATE so it looks like it goes down while the other comes from above
				//// if/elses >> player1.items[j+1].srcY + animVar, while ctxMenu.clearRect the bottom
				////					and same backwards (at the same time) for item coming from the top
          //// so draw both, cover top&bottom and move them down together until second one fits first one's place.....

          						/// pretty much like this below, together with the other one... BUT check that if player1.items[j] then .length-1


						///ONLY DRAW IF SELECTABLE!!!  and only apply effects if items-> thisRow <<<< MORE THAN ONE
							///// so duplicate this if elses and >> if player1.items 
									if(j>0){

										/// DONT DO THIS SHIFT IF FIRST-PRESS\\\\\\
										ctxMenu.drawImage(itemSprite, player1.items[j+1].srcX, player1.items[j+1].srcY, 30, 30, 170, 40+(2*menuCount), player1.items[j+1].width, player1.items[j+1].height);


	          							ctxMenu.drawImage(itemSprite, player1.items[j].srcX, player1.items[j].srcY, 30, 30, 170, 100+(2*menuCount), player1.items[j].width, player1.items[j].height);
	          						}else{

	          							if(player1.items.length<=1){

	          								
		          							ctxMenu.drawImage(itemSprite, player1.items[j+1].srcX, player1.items[j+1].srcY, 30, 30, 170, 100+(2*menuCount), player1.items[j+1].width, player1.items[j+1].height);
		          						///then when there's more it can swap them with animations !!!!!!!!!!
	          							}else{
	          								ctxMenu.drawImage(itemSprite, player1.items[j+1].srcX, player1.items[j+1].srcY, 30, 30, 170, 40+(2*menuCount), player1.items[j+1].width, player1.items[j+1].height);
	          								ctxMenu.drawImage(itemSprite, player1.items[player1.items.length-1].srcX, player1.items[player1.items.length-1].srcY, 30, 30, 170, 100+(2*menuCount), player1.items[player1.items.length-1].width, player1.items[player1.items.length-1].height);
	          							}
	          						}

	          					/// or do it the simple way:  comment out  if(j>0){ above, and uncomment this one
	          						//ctxMenu.drawImage(itemSprite, player1.items[j+1].srcX, player1.items[j+1].srcY, 30, 30, 170, 100, player1.items[j+1].width, player1.items[j+1].height);
						 ...
						 for (var j = 0;j<player1.guns.length; j ++) {
							...
							if(gunRow==j){
								if(typeof player1.guns[j+1]!="undefined"){
									ctxMenu.clearRect(230,100, player1.guns[j+1].width ,player1.guns[j+1].height);
...
//clearCtx(ctxMenu);
	...
	//// so this is only the Menu higliters that are being drawn, and the edges and frame.. not the actual content
	...
	for (var i = 0; i<player1.life; i++) {
		...
		ctxOverlay.drawImage(itemSprite,770, 300, 5, 10, 60+shifto, window.innerHeight-120,5, 10); ///////////// ctx player so it gets updated
		shifto+=7;
	};
			...
			for(var e=0; e<roomNumberTilesX; e++){
					...
					if(mapObsL2[tileMapIndex].toString().substring(0,1)==1){ ///////// area (default)
						...
						if(inActive.length==0){
							...
							if(inAct){
								obstacles.push(
									new Obstacle(tileIndexX+shiftX, tileIndexY+shiftY, tileWidthHeight, tileWidthHeight, "door", mapObsL2[tileMapIndex], "inActive")//// ID has to be = to the tileNumber
									);
					...
					if(mapOverDraw[tileMapIndex].toString().substring(0,1)==1){
						...
						if(!inArea.inIt){   
							...
							/// >>>>  HERE could go  EDGES -UNDER - PLAYER 
								...
								ctxBg.drawImage(img, srcX, 40, 40, 40, tileIndexX, tileIndexY, tileWidthHeight/*+variance*/, tileWidthHeight/*+variance*/);
						}
						...
						for(var e = 0; e<roomToMap.length; e++){ /////////  room2map >>> 1map, 3 map >>> SEGUN DONDE VAYA
							if(roomToMap[e]==doorID){
								...
								if((e/roomNumberTilesY)*tileDiameter>window.outerHeight/2){
									...
									daVar = (window.outerHeight/1.5)-(e/roomNumberTilesY)*tileDiameter;
...
Player.prototype.update = function () {
	...
	////// animCount  SHOULD BE DIRECTLY RELATED TO player1.speed !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
Player.prototype.checkMoving = function (direction, moving) {
	...
	if(this.moving){
		...
		//so just like DASH >> var here, var there, and it works now
		/// checking for opening alone will keep player moving when releasing keys
				////   forget it, doens't really work
		// if(opening){
		// 	if(openingCount<1){ /// only works with 1 & 3
		// 					//// so it works now, but who knows
		// 		player1.direction="stop! rebel scum";  	
		// 	}else{
		// 		if(latestKeys[0]==39){
		// 			player1.direction="right";
...
// 						ctxMenu.clearRect(170,100,60, 60);
// 		  				ctxMenu.clearRect(170,60,60, 60);
...
// 									if(j>0){
// 										ctxMenu.drawImage(itemSprite, player1.items[j+1].srcX, player1.items[j+1].srcY, 30, 30, 170, 60, player1.items[j+1].width, player1.items[j+1].height);

// 	          							ctxMenu.drawImage(itemSprite, player1.items[j].srcX, player1.items[j].srcY, 30, 30, 170, 100, player1.items[j].width, player1.items[j].height);
// 	          						}else{
// 	          							///there you go, so when theres only 1 item (1 plus "initiating-ghost one"=>> length<=2) >>>   then it doesn't do the animation thing
// 	          							if( player1.items.length<=2){
// 		          							console.log(player1.items.length);
// 		          							ctxMenu.drawImage(itemSprite, player1.items[j+1].srcX, player1.items[j+1].srcY, 30, 30, 170, 100, player1.items[j+1].width, player1.items[j+1].height);
// 		          						///then when there's more it can swap them with animations !!!!!!!!!!
// 	          							}else{
// 	          								ctxMenu.drawImage(itemSprite, player1.items[j+1].srcX, player1.items[j+1].srcY, 30, 30, 170, 60, player1.items[j+1].width, player1.items[j+1].height);
// 	          								ctxMenu.drawImage(itemSprite, player1.items[player1.items.length-1].srcX, player1.items[player1.items.length-1].srcY, 30, 30, 170, 100, player1.items[player1.items.length-1].width, player1.items[player1.items.length-1].height);
// 	          							}
// 	          						}
